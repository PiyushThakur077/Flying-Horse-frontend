                              ...
                              segments: <ButtonSegment<String>>[
                                ButtonSegment<String>(
                                  ...
                                  label: Text(
                                    'Truck',
                                    style:
                                        AppTextStyle.mediumStyle(fontSize: 16),
                            ...
                            () => CommonTextInput(
                              ...
                              selectedSegment:
                                  controller.fuelQuantityUnit.value == 'liters'
                                      ? 'Liters'
                                      : 'Gallon',
                              onChanged: (value) => controller.fuelQuantity
                                  .value = double.tryParse(value) ?? 0.0,
                              onSegmentSelected: (value) {
                              ...
                              validator: (value) {
                                ...
                                return controller
                                    .validateFuelQuantity(parsedValue);
                              },
                              readOnly: true,
                            ),
                          ),
